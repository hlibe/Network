...
get_network_characteristics <- function(gh){
  ...
  cat("The variance of overall degree:",var_overall_m,"\n")
  ...
  new_list = list("number_of_nodes"=a, "number_of_edges"=b, "average_overall_degree"=c,
                  "average_outdegree"=d, "giant_component_size"=e, "second_largest_component"=f,
                  "number_of_isolated_nodes"=g, "variance_of_overall_degree"=var_overall_m,
                  "variance_of_outdegree"=var_m)
  return(new_list)
}
